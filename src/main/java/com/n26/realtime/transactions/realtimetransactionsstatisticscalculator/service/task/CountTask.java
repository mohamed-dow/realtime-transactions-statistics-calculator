...
public class CountTask implements Callable<TaskResults> {
  ...
  public CountTask(Map<Long, Double> transactionListFor60Seconds) {
  ...
  public TaskResults call() {
    ...
    result.setTaskResult(
        this.transactionListFor60Seconds.size());
    LOGGER.info("Count Task took: [{}ms]", System.currentTimeMillis() - start);
    return result;
  }
